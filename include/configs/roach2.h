...
#define CONFIG_EXTRA_ENV_SETTINGS     \
        ...
        "type  run soloboot  to run from flash independent of network; echo\0" \
        "netdev=eth0\0" \
        "bootdelay=2\0" \
        "bootargs=console=ttyS0,115200\0" \
        "clearenv=protect off fff40000 fff7ffff;era fff40000 fff7ffff;protect on fff40000 fff7ffff\0" \
        "yget=loady 0x4000000\0" \
        "writeuboot=protect off 0xfff80000 0xffffffff; era 0xfff80000 0xffffffff; cp.b 0x4000000 0xfff80000 ${filesize}; protect on 0xfff80000 0xffffffff\0" \
...
#define CONFIG_SYS_EBC_PB1AP  (EBC_AP_TWT(2) | EBC_AP_CSN(0) | EBC_AP_OEN(1) | EBC_AP_WBN(0) | EBC_AP_WBF(0) | EBC_AP_TH(1) | EBC_AP_RE | EBC_AP_SOR) 
...
{GPIO0_BASE, GPIO_OUT, GPIO_SEL , GPIO_OUT_0}, /* GPIO22 PB_KILLn */  \
...
{GPIO0_BASE, GPIO_OUT, GPIO_SEL , GPIO_OUT_0}, /* GPIO29 EBC_EXT_HDLA  USB2D_PAD_SUSPNDM - PPC_GPIO[4] (Activity LED) */  \
...
{GPIO0_BASE, GPIO_OUT, GPIO_ALT1, GPIO_OUT_0}, /* GPIO9  EBC_CS_N(4)      */  \
{GPIO0_BASE, GPIO_OUT, GPIO_SEL,  GPIO_OUT_0}, /* GPIO10 EBC_CS_N(5)      */  \
{GPIO0_BASE, GPIO_OUT, GPIO_SEL , GPIO_OUT_0}, /* GPIO11 EBC_BUS_ERR      */  \
{GPIO0_BASE, GPIO_IN , GPIO_SEL , GPIO_OUT_0}, /* GPIO12 - SelectMAP INITn */  \
{GPIO0_BASE, GPIO_IN , GPIO_SEL , GPIO_OUT_0}, /* GPIO13 - SelectMAP DONE */  \
{GPIO0_BASE, GPIO_OUT, GPIO_SEL , GPIO_OUT_1}, /* GPIO14 - SelectMAP PROGn */  \
{GPIO0_BASE, GPIO_OUT, GPIO_SEL , GPIO_OUT_1}, /* GPIO15 - SelectMAP RDWRn */  \
